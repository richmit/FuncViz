...
magick -delay 1 -loop 0 -dispose previous ../old-media/surface_plot_annular_edge_rot.*.png -resize 25% surface_plot_annular_edge_rot_50.gif;
...
magick -delay 1 -loop 0 -dispose previous ../old-media/holy_wave_surf_rot.*.png -resize 25% holy_wave_surf_rot_50.gif;
