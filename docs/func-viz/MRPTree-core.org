...
# ######################################################################################################################################################.H.S.##
# FILE:        MRPTree-core.org
#+TITLE:       MRPTree Core Examples
#+AUTHOR:      Mitch Richling
#+EMAIL:       http://www.mitchr.me/
#+DATE:        2024-09-18
#+DESCRIPTION: Examples demonstrating most of the MRPTree library via function visualization.
...
Most of the example programs on this page may be found in the cookbook; however, this collection is targeted at providing a concise set of examples to
demonstrate the most important [[https://github.com/richmit/MRPTree][MRPTree]] functionality.  
