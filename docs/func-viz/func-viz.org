...
#+begin_src sh :results output verbatum :exports results :wrap "src c++ :eval never :tangle no"
grep -EA 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/surface_plot_annular_edge.cpp | grep -vE '(!|#|\*|=|_|-|%|;|C|/){70,}' | grep -vE '@(cond|endcond)'
#+end_src
...
#+begin_src sh :results output verbatum :exports results :wrap "src c++ :eval never :tangle no"
grep -EA 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/holy_wave_surf.cpp | grep -vE '(!|#|\*|=|_|-|%|;|C|/){70,}' | grep -vE '@(cond|endcond)'
#+end_src
...
#+RESULTS:
#+begin_example
make media/hello_MRaster_100.png
make media/hello_MRaster_50.png
make media/hello_MRaster_25.png
make media/hello_MRaster_10.png
make media/hello_world_100.png
make media/hello_world_50.png
make media/hello_world_25.png
make media/hello_world_10.png
#+end_example
...
#+RESULTS:
#+begin_example
make media/holy_wave_surf_rot_10.gif
make media/holy_wave_surf_rot_25.gif
make media/holy_wave_surf_rot_50.gif
#+end_example
...
#+RESULTS:
#+begin_example
make media/holy_wave_surf_rot_100_crf30.webm
make media/holy_wave_surf_rot_25_crf30.webm
make media/holy_wave_surf_rot_50_crf30.webm
