...
[[file:media/complex_magnitude_surface_rot_100.html][file:media/complex_magnitude_surface_rot_10.gif]]
#+END_CENTER
...
#+BEGIN_CENTER
[[file:media/implicit_surface_rt_rot_100.html][file:media/implicit_surface_rt_rot_10.gif]]
[[file:media/implicit_surface_make_50.gif][file:media/implicit_surface_make_10.gif]]
#+END_CENTER
...
#+begin_src sh :results output raw :exports results 
grep -EB 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/surface_branch_glue.cpp | grep -EA 10000 '@filedetails' | head -n -2 | grep -v '@filedetails' | sed 's/ @f\$/ \\(/g; s/@f\$\([ .,!]\)/\\)\1/g;'
#+end_src
...
#+BEGIN_CENTER
[[file:media/trefoil_rot_50.html][file:media/trefoil_rot_10.gif]]
#+END_CENTER
...
#+begin_src sh :results output raw :exports results 
grep -EB 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/parametric_curve_3d.cpp | grep -EA 10000 '@filedetails' | head -n -2 | grep -v '@filedetails' | sed 's/ @f\$/ \\(/g; s/@f\$\([ .,!]\)/\\)\1/g;'
#+end_src
...
make media/parametric_curve_3d_rot_10.gif
make media/parametric_curve_3d_rot_25.gif
make media/parametric_curve_3d_rot_50.gif
...
* Image Processing: WEBMs                                          :noexport:

** Put media in place

#+begin_src sh  :results output verbatum :exports both
for f in ../../paraview/*.webm; do
  b=$(echo $f | sed 's/^.*\///')
  fn="media/${b}"
  if [ $f -nt $fn ]; then
    echo make $fn
...
#+RESULTS:
#+begin_example
skip media/complex_magnitude_surface_rot_100.webm
skip media/complex_magnitude_surface_rot_25.webm
skip media/complex_magnitude_surface_rot_50.webm
skip media/implicit_surface_rt_rot_100.webm
skip media/implicit_surface_rt_rot_25.webm
skip media/implicit_surface_rt_rot_50.webm
skip media/lorenz_rot_25.webm
make media/parametric_curve_3d_rot_100_crf30.webm
make media/parametric_curve_3d_rot_100_lossless.webm
make media/parametric_curve_3d_rot_25_crf30.webm
make media/parametric_curve_3d_rot_25_lossless.webm
make media/parametric_curve_3d_rot_50_crf30.webm
make media/parametric_curve_3d_rot_50_lossless.webm
skip media/trefoil_rot_100.webm
skip media/trefoil_rot_25.webm
skip media/trefoil_rot_50.webm
#+end_example
...
Processing Example complex_magnitude_surface
  skip media/complex_magnitude_surface_rot_100.html
  skip media/complex_magnitude_surface_rot_25.html
  skip media/complex_magnitude_surface_rot_50.html
Processing Example implicit_surface
  skip media/implicit_surface_rt_rot_100.html
  skip media/implicit_surface_rt_rot_25.html
  skip media/implicit_surface_rt_rot_50.html
Processing Example lorenz
  skip media/lorenz_rot_25.html
Processing Example trefoil
  skip media/trefoil_rot_100.html
  skip media/trefoil_rot_25.html
  skip media/trefoil_rot_50.html
Processing Example parametric_curve_3d
  make media/parametric_curve_3d_rot_100_crf30.html
  make media/parametric_curve_3d_rot_100_lossless.html
  make media/parametric_curve_3d_rot_25_crf30.html
  make media/parametric_curve_3d_rot_25_lossless.html
  make media/parametric_curve_3d_rot_50_crf30.html
  make media/parametric_curve_3d_rot_50_lossless.html
#+end_example
