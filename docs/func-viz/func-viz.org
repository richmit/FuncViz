...
#+RESULTS:
#+begin_example
make media/surface_plot_annular_edge_rot_10.gif
make media/surface_plot_annular_edge_rot_25.gif
make media/surface_plot_annular_edge_rot_50.gif
#+end_example
...
make media/surface_plot_annular_edge_rot_100_crf30.webm
make media/surface_plot_annular_edge_rot_25_crf30.webm
make media/surface_plot_annular_edge_rot_50_crf30.webm
#+end_example

*** Create HTML Wrappers

#+begin_src sh :results output verbatum
for e in complex_magnitude_surface implicit_surface lorenz trefoil parametric_curve_3d surface_plot_corner ear_surface surface_plot_annular_edge; do
