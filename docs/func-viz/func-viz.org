...
#+begin_src sh :results output raw :exports results 
grep -EB 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/surface_plot_step.cpp | grep -EA 10000 '@filedetails' | head -n -2 | grep -v '@filedetails' | sed 's/ @f\$/ \\(/g; s/@f\$\([ .,!:]\)/\\)\1/g; s/@f\[/\\[/g; s/@f]/\\]/g; s/^ *\\verbatim/#+BEGIN_EXAMPLE/; s/^ *\\endverbatim/#+END_EXAMPLE/;'
#+end_src
...
#+begin_src sh :results output verbatum :exports results :wrap "src c++ :eval never :tangle no"
grep -EA 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/surface_plot_step.cpp | grep -vE '(!|#|\*|=|_|-|%|;|C|/){70,}' | grep -vE '@(cond|endcond)'
#+end_src
...
#+begin_src sh :results output raw :exports results 
grep -EB 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/ear_surface.cpp | grep -EA 10000 '@filedetails' | head -n -2 | grep -v '@filedetails' | sed 's/ @f\$/ \\(/g; s/@f\$\([ .,!:]\)/\\)\1/g; s/@f\[/\\[/g; s/@f]/\\]/g; s/^ *\\verbatim/#+BEGIN_EXAMPLE/; s/^ *\\endverbatim/#+END_EXAMPLE/;'
#+end_src
...
#+begin_src sh :results output verbatum :exports results :wrap "src c++ :eval never :tangle no"
grep -EA 10000 '(!|#|\*|=|_|-|%|;|C|/){70,}\.H\.E\.' ../../examples/ear_surface.cpp | grep -vE '(!|#|\*|=|_|-|%|;|C|/){70,}' | grep -vE '@(cond|endcond)'
#+end_src
...
#+RESULTS:
#+begin_example
make media/surface_plot_step-cut_100.png
make media/surface_plot_step-cut_50.png
make media/surface_plot_step-cut_25.png
make media/surface_plot_step-cut_10.png
make media/surface_plot_step-noCut_100.png
make media/surface_plot_step-noCut_50.png
make media/surface_plot_step-noCut_25.png
make media/surface_plot_step-noCut_10.png
#+end_example
...
make media/ear_surface_rot_10.gif
make media/ear_surface_rot_25.gif
make media/ear_surface_rot_50.gif
...
make media/ear_surface_rot_100_crf30.webm
make media/ear_surface_rot_25_crf30.webm
make media/ear_surface_rot_50_crf30.webm
...
skip media/surface_plot_corner_rot_100_crf30.webm
skip media/surface_plot_corner_rot_25_crf30.webm
skip media/surface_plot_corner_rot_50_crf30.webm
...
#+begin_src sh :results output verbatum
for e in complex_magnitude_surface implicit_surface lorenz trefoil parametric_curve_3d surface_plot_corner ear_surface; do
